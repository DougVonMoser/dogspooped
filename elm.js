				...
				A2(
					...
					A2(
						...
						A2(
							elm$core$Array$get,
							0,
							A2(elm$core$Debug$log, 'somehting', timeArray))))));
	});
		...
		if (bigmodel.$ === 'GettingTimeZone') {
			...
			switch (msg.$) {
				...
				case 'AdjustmentEvent':
					...
					if (_n5.$ === 'InProgress') {
						var occurence = _n5.a;
						var inputValue = _n5.b;
						return _Utils_Tuple2(
							author$project$Main$TimeZoneLoaded(
								_Utils_update(
									model,
									{
										timeAdjust: A2(author$project$Main$InProgress, occurence, rawInput)
									})),
							elm$core$Platform$Cmd$none);
					} else {
						return _Utils_Tuple2(bigmodel, elm$core$Platform$Cmd$none);
				...
				case 'CloseAndUpdateTime':
					var _n6 = model.timeAdjust;
					if (_n6.$ === 'InProgress') {
						var occurence = _n6.a;
						var inputValue = _n6.b;
						var _n7 = A2(author$project$Main$parseInputToPosix, inputValue, model.zone);
						if (_n7.$ === 'Just') {
							var updatedPosix = _n7.a;
							var newDogs = A3(author$project$Main$adjustDogOccurence, occurence, model.dogs, updatedPosix);
							return _Utils_Tuple2(
								author$project$Main$TimeZoneLoaded(
									_Utils_update(
										model,
...
var author$project$Main$view = function (model) {
	if (model.$ === 'GettingTimeZone') {
		...
		return A2(
			...
			_List_fromArray(
				[
					rtfeldman$elm_css$Html$Styled$Attributes$class('main-container')
				]),
			_List_fromArray(
				[
					A2(
