		...
		if (bigmodel.$ === 'GettingTimeZone') {
			...
			switch (msg.$) {
						...
						return _Utils_Tuple2(
							author$project$Main$TimeZoneLoaded(
								_Utils_update(
									model,
									{
										timeAdjust: A2(author$project$Main$InProgress, occurence, updatedInput)
									})),
							elm$core$Platform$Cmd$none);
					} else {
						return _Utils_Tuple2(bigmodel, elm$core$Platform$Cmd$none);
				...
				case 'CloseAndUpdateTime':
					var _n7 = model.timeAdjust;
					if (_n7.$ === 'InProgress') {
						var occurence = _n7.a;
						var inputValue = _n7.b;
						var _n8 = A2(author$project$Main$parseInputToPosix, inputValue, model.zone);
						if (_n8.$ === 'Just') {
